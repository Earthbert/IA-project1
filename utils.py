...
def prof_initials(prof : str, profs_to_initials : dict[str, str], initials_count: dict[str, int]) -> str:
    '''
...
def pretty_print_timetable_aux_zile(timetable : dict[str, dict[tuple[int, int], dict[str, tuple[str, str]]]]) -> str:
    '''
...
def pretty_print_timetable_aux_intervale(timetable : dict[tuple[int, int], dict[str, dict[str, tuple[str, str]]]]) -> str:
    '''
